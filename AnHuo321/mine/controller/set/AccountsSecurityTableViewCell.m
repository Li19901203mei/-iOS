//
//  AccountsSecurityTableViewCell.m
//  AnHuo321
//
...
@implementation AccountsSecurityTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.rightLable.font = VFont;
        [self addSubview:self.rightLable];
        [self.rightLable mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.mas_equalTo(self.leftLable.mas_right).offset(width(5));
            make.centerY.mas_equalTo(self.mas_centerY);
            make.right.mas_equalTo(self.rightImg.mas_left).offset(-width(10));
            make.height.mas_equalTo(height(20));
        }];
    }
    return self;
