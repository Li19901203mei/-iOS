...
@implementation YiRecordTableViewCell
...
-(void)chuanZhiTiRecordModel:(TiRecordModel*)model{
    self.numLable.text =[NSString stringWithFormat:@"提现金额:%@元",model.money];
    self.nameLable.text =[NSString stringWithFormat:@"%@",model.status];
    self.timeLable.text =[NSString stringWithFormat:@"时间:%@",model.apply_time];
