...
#import "YiRecordTableViewCell.h"
#import "TiRecordModel.h"
@interface TiRecordViewController ()<UITableViewDataSource,UITableViewDelegate>
@property(nonatomic,strong)UITableView * tiRecordView;
@property(nonatomic,strong)NSMutableArray * dataArr;
@property(nonatomic,assign)int page;
@end

@implementation TiRecordViewController
...
- (void)viewDidLoad {
    ...
    [self.tiRecordView registerClass:[YiRecordTableViewCell class] forCellReuseIdentifier:@"YiRecordTableViewCell"];
...
-(void)load_getUserPledgeTake:(BOOL)isYes{
    [HttpTool post:KURLNSString(GetUserPledgeTake) dic:@{@"rows":@"15",@"page":[NSString stringWithFormat:@"%d",self.page]} success:^(id  _Nonnull responce) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    YiRecordTableViewCell * cell =[tableView dequeueReusableCellWithIdentifier:@"YiRecordTableViewCell"];
